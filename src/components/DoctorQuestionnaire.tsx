...
import { Stethoscope, User, GraduationCap, Award, Globe, Phone, Mail, Calendar, Camera } from "lucide-react";
import { useState } from "react";

export function DoctorQuestionnaire() {
        ...
        >
          <Card className="bg-gradient-to-b from-[#1A1A1A] to-[#0E0E0E] border border-[#2A2A2A] shadow-2xl">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-[32px] mb-2" style={{ fontFamily: "ClashDisplay, system-ui, sans-serif", fontWeight: 600 }}>
                Doctor Information Form
              </CardTitle>
              <CardDescription className="text-[#B0B0B0] text-lg">
                Help us understand your practice to build the perfect website for you
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    <GraduationCap className="w-5 h-5 text-[#00BCD4]" />
                    <h3 className="text-[24px]" style={{ fontFamily: "ClashDisplay, system-ui, sans-serif", fontWeight: 600 }}>
                      Professional Information
                    </h3>
                  </div>
